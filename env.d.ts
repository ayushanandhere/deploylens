/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 48cb105015d465b2f34e94f2e60c7a2c)
// Runtime types generated with workerd@1.20260918.1 2026-09-20 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	PUBLIC_ORIGIN: "https://deploylens.ayushanandhere.workers.dev";
	INFERENCE_ENABLED: "true";
	PRIVATE_MODEL_DAILY: "80";
	DEMO_SESSION_MODEL_DAILY: "12";
	DEMO_SHARED_MODEL_DAILY: "240";
	GLOBAL_MODEL_DAILY: "500";
	DEMO_TTL_HOURS: "48";
	PRIVATE_SESSION_DAYS: "14";
	DEMO_SESSIONS_DAILY: "1000";
	DEMO_INVESTIGATIONS_DAILY: "8";
	DEMO_SHARED_INVESTIGATIONS_DAILY: "500";
	PRIVATE_INVESTIGATIONS_DAILY: "30";
	DeployLensAgent: DurableObjectNamespace<import("./src/server").DeployLensAgent>;
	DeployLensControl: DurableObjectNamespace<import("./src/server").DeployLensControl>;
	DeployLensQuota: DurableObjectNamespace<import("./src/server").DeployLensQuota>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "DeployLensAgent" | "DeployLensControl" | "DeployLensQuota";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "INFERENCE_ENABLED" | "PRIVATE_MODEL_DAILY" | "DEMO_SESSION_MODEL_DAILY" | "DEMO_SHARED_MODEL_DAILY" | "GLOBAL_MODEL_DAILY" | "DEMO_TTL_HOURS" | "PRIVATE_SESSION_DAYS" | "DEMO_SESSIONS_DAILY" | "DEMO_INVESTIGATIONS_DAILY" | "DEMO_SHARED_INVESTIGATIONS_DAILY" | "PRIVATE_INVESTIGATIONS_DAILY">> {}
}
